...
var render = function() {
  ...
  return _c(
    "modal",
    {
      attrs: {
        name: "new-project",
        classes: "p-4 bg-card rounde-lg w-full",
        height: "auto"
      }
    },
    [
            ...
            _c("div", { staticClass: "flex-1 mr-4" }, [
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("textarea", {
                  ...
                  staticClass:
                    "border border-muted-light p-2 text-sm block w-full rounded",
                ...
                [
                  ...
                  _vm._l(_vm.form.tasks, function(task) {
                    return _c("input", {
                      ...
                      staticClass:
                        "border border-muted-light p-2 mb-2 text-sm block w-full rounded",
                      attrs: {
                        type: "text",
                        id: "title",
                        placeholder: "Task 1"
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.themes, function(color, theme) {
      return _c("button", {
        staticClass:
          "rounded-full w-4 h4 bg-default border mr-2 focus:outline-none",
...
vue__WEBPACK_IMPORTED_MODULE_1___default.a.component('new-project-modal', __webpack_require__(/*! ./components/NewProjectModal.vue */ "./resources/js/components/NewProjectModal.vue")["default"]); //Vue.component('new-project-modal', require('./components/NewProjectModal.vue').default);
...
__webpack_require__(/*! D:\MyFolder\Mamicamp\Course\9.BuildLaravelandTDD\project\Fix\birdboard\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\MyFolder\Mamicamp\Course\9.BuildLaravelandTDD\project\Fix\birdboard\resources\sass\app.scss */"./resources/sass/app.scss");

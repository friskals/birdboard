...
<header class="flex items-center mb-6 pb-4">
    <div class="flex justify-between items-end w-full">
        ...
        <div class="flex items-center">
            ...
            <a href="{{ $project->path().'/edit' }}" class="button ml-4 no-underline text-white">Edit Project</a>
        </div>
        ...
        <div class="lg:w-3/4 px-3 mb-6">
            ...
            <div>
                ...
                <form method="POST" action="{{$project->path()}}">
                    ...
                    <textarea name="notes" class="card text-default w-full mb-4" style="min-height: 200px" placeholder="Anything special that you want to make a note of?">
                    {{trim($project->notes)}}
                    </textarea>
